...
//    @RequestMapping(value = "/shortener", method=RequestMethod.POST, consumes = {"application/json"})
    public String shortenUrl(@Valid ShortenRequest shortenRequest) throws Exception {
...
//    @RequestMapping(value = "/{id}", method=RequestMethod.GET)
    public RedirectView redirectUrl(String id, HttpServletRequest request) throws IOException, URISyntaxException, Exception {
